...
class LowPriceItemsPage extends StatefulWidget {
  ...
  const LowPriceItemsPage({Key? key, required this.featuredItems}) : super(key: key);

  @override
  State<LowPriceItemsPage> createState() => _FeaturedItemsPageState();
}

class _FeaturedItemsPageState extends State<LowPriceItemsPage> {
