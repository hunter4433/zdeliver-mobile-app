...
class StaplePage extends StatefulWidget {
  const StaplePage({Key? key}) : super(key: key);


  @override
  State<StaplePage> createState() => _StaplePageState();
}


class _StaplePageState extends State<StaplePage> {
  ...
  Future<void> fetchItems() async {
    try {
      final response = await http.post(
        ...
        body: jsonEncode({"category": "staples"}), // Change category if needed
      );
  ...
  //     'image': 'assests/potato_png2391.png',
  //     'options': ['Big ones', 'Small ones']
  //   },
  //   {
  //     'name': 'Capsicum',
  //     'unit': 'kilos',
  //     'description': 'Make paratha, aloo sabzi, vadapao, dam aloo, aloo matar, aloo pakoda',
  //     'image': 'assests/color-capsicum.png',
